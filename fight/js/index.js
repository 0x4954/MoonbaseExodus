...
import { PBody, pUpdate } from "./pbody.js";
import Transform from "./transform.js";
import { vAdd, vMulN } from "./vec.js";
...
const player1 = new Sprite('#f00', new PBody(100, 200, 70, 150));
player1.setContext(context);

const player2 = new Sprite('#00f', new PBody(900, 200, 70, 150));
